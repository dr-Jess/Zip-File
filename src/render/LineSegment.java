...
public class LineSegment {
    ...
    public LineSegment rotateAbout(Coordinate origin, double xRotation, double yRotation, double zRotation){
        return new LineSegment(
                start.rotateAbout(origin, xRotation, yRotation, zRotation),
                end.rotateAbout(origin, xRotation, yRotation, zRotation));
    }
